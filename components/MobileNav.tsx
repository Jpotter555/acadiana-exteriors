    ...
    <div className="md:hidden">
      <div className="flex items-center gap-3">
        <a
          ...
          className="bg-primary text-white p-2.5 rounded-full hover:bg-primary-700 transition shadow-md"
          aria-label="Call us"
        >
        ...
        <div className="absolute top-full left-0 right-0 bg-white border-b border-gray-200 shadow-lg z-50">
          <div className="px-4 py-4 space-y-3">
            ...
            <Link
              href="/quote"
              onClick={() => setIsOpen(false)}
              className="block bg-secondary text-white text-center px-4 py-3 rounded-lg hover:bg-secondary-700 transition font-bold shadow-md"
            >
              Get a Quote
            </Link>
